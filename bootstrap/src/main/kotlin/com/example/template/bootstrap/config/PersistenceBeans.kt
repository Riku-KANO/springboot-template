 ...
 */
fun persistenceBeans() =
    beans {
        bean<OrderRepository> { OrderRepositoryAdapter(ref(), ref()) }
        bean<SettlementRepository> { SettlementRepositoryAdapter(ref()) }
        bean<TxRunner> { R2dbcTxRunner(ref()) }
    }
